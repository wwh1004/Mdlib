...
namespace Mdlib.DotNet.Metadata {
	...
	public sealed unsafe class ModuleRow : TableRow {
		...
		public uint Name => ReadHeapOffset(RawDataUnsafe + 2 + ToOffsetSize(_table.IsBigStrings), _table.IsBigStrings);
		// USHORT + STRING

		public uint Mvid => ReadHeapOffset(RawDataUnsafe + 2 + ToOffsetSize(_table.IsBigStrings) + ToOffsetSize(_table.IsBigGuid), _table.IsBigGuid);
		// USHORT + STRING + GUID

		public uint EncId => ReadHeapOffset(RawDataUnsafe + 2 + ToOffsetSize(_table.IsBigStrings) + ToOffsetSize(_table.IsBigGuid) + ToOffsetSize(_table.IsBigGuid), _table.IsBigGuid);
		// USHORT + STRING + GUID + GUID

		public uint EncBaseId => ReadHeapOffset(RawDataUnsafe + 2 + ToOffsetSize(_table.IsBigStrings) + ToOffsetSize(_table.IsBigGuid) + ToOffsetSize(_table.IsBigGuid) + ToOffsetSize(_table.IsBigGuid), _table.IsBigGuid);
	...
	public sealed unsafe class TypeRefRow : TableRow {
		...
		public uint Namespace => ReadHeapOffset(RawDataUnsafe + 2 + ToOffsetSize(_table.IsBigStrings) + ToOffsetSize(_table.IsBigStrings), _table.IsBigStrings);
	...
	public sealed unsafe class TypeDefRow : TableRow {
		...
		public uint Name => ReadHeapOffset(RawDataUnsafe + 4 + ToOffsetSize(_table.IsBigStrings), _table.IsBigStrings);
		// ULONG + STRING

		public uint Namespace => ReadHeapOffset(RawDataUnsafe + 4 + ToOffsetSize(_table.IsBigStrings) + ToOffsetSize(_table.IsBigStrings), _table.IsBigStrings);
		// ULONG + STRING + STRING

		public uint Extends => ReadUInt16(RawDataUnsafe + 4 + ToOffsetSize(_table.IsBigStrings) + ToOffsetSize(_table.IsBigStrings) + 2);
		// ULONG + STRING + STRING + CODED_TOKEN

		public uint FieldList => ReadUInt16(RawDataUnsafe + 4 + ToOffsetSize(_table.IsBigStrings) + ToOffsetSize(_table.IsBigStrings) + 2 + 2);
		// ULONG + STRING + STRING + CODED_TOKEN + RID

		public uint MethodList => ReadUInt16(RawDataUnsafe + 4 + ToOffsetSize(_table.IsBigStrings) + ToOffsetSize(_table.IsBigStrings) + 2 + 2 + 2);
	...
	public sealed unsafe class FieldRow : TableRow {
		...
		public uint Signature => ReadHeapOffset(RawDataUnsafe + 2 + ToOffsetSize(_table.IsBigStrings) + ToOffsetSize(_table.IsBigBlob), _table.IsBigBlob);
		// USHORT + STRING + BLOB
	...
	public sealed unsafe class MethodRow : TableRow {
		...
		public uint Name => ReadHeapOffset(RawDataUnsafe + 4 + 2 + 2 + ToOffsetSize(_table.IsBigStrings), _table.IsBigStrings);
		// ULONG + USHORT + USHORT + STRING

		public uint Signature => ReadHeapOffset(RawDataUnsafe + 4 + 2 + 2 + ToOffsetSize(_table.IsBigStrings) + ToOffsetSize(_table.IsBigBlob), _table.IsBigBlob);
		// ULONG + USHORT + USHORT + STRING + BLOB

		public uint ParamList => ReadUInt16(RawDataUnsafe + 4 + 2 + 2 + ToOffsetSize(_table.IsBigStrings) + ToOffsetSize(_table.IsBigBlob) + 2);
	...
	public sealed unsafe class ParamRow : TableRow {
		...
		public uint Name => ReadHeapOffset(RawDataUnsafe + 2 + 2 + ToOffsetSize(_table.IsBigStrings), _table.IsBigStrings);
	...
	public sealed unsafe class EventRow : TableRow {
		...
		public uint EventType => ReadUInt16(RawDataUnsafe + 2 + ToOffsetSize(_table.IsBigStrings) + 2);
	...
	public sealed unsafe class PropertyRow : TableRow {
		...
		public uint Type => ReadHeapOffset(RawDataUnsafe + 2 + ToOffsetSize(_table.IsBigStrings) + ToOffsetSize(_table.IsBigBlob), _table.IsBigBlob);
		// USHORT + STRING + BLOB
	...
	public sealed unsafe class ModuleRefRow : TableRow {
		...
		public uint Name => ReadHeapOffset(RawDataUnsafe + ToOffsetSize(_table.IsBigStrings), _table.IsBigStrings);
		// STRING
	...
	public sealed unsafe class ImplMapRow : TableRow {
		...
		public uint ImportName => ReadHeapOffset(RawDataUnsafe + 2 + 2 + ToOffsetSize(_table.IsBigStrings), _table.IsBigStrings);
		// USHORT + CODED_TOKEN + STRING

		public uint ImportScope => ReadUInt16(RawDataUnsafe + 2 + 2 + ToOffsetSize(_table.IsBigStrings) + 2);
	...
	public sealed unsafe class AssemblyRow : TableRow {
		...
		public uint Name => ReadHeapOffset(RawDataUnsafe + 4 + 2 + 2 + 2 + 2 + 4 + ToOffsetSize(_table.IsBigBlob) + ToOffsetSize(_table.IsBigStrings), _table.IsBigStrings);
		// ULONG + USHORT + USHORT + USHORT + USHORT + ULONG + BLOB + STRING

		public uint Locale => ReadHeapOffset(RawDataUnsafe + 4 + 2 + 2 + 2 + 2 + 4 + ToOffsetSize(_table.IsBigBlob) + ToOffsetSize(_table.IsBigStrings) + ToOffsetSize(_table.IsBigStrings), _table.IsBigStrings);
	...
	public sealed unsafe class AssemblyRefRow : TableRow {
		...
		public uint Name => ReadHeapOffset(RawDataUnsafe + 2 + 2 + 2 + 2 + 4 + ToOffsetSize(_table.IsBigBlob) + ToOffsetSize(_table.IsBigStrings), _table.IsBigStrings);
		// USHORT + USHORT + USHORT + USHORT + ULONG + BLOB + STRING

		public uint Locale => ReadHeapOffset(RawDataUnsafe + 2 + 2 + 2 + 2 + 4 + ToOffsetSize(_table.IsBigBlob) + ToOffsetSize(_table.IsBigStrings) + ToOffsetSize(_table.IsBigStrings), _table.IsBigStrings);
		// USHORT + USHORT + USHORT + USHORT + ULONG + BLOB + STRING + STRING

		public uint HashValue => ReadHeapOffset(RawDataUnsafe + 2 + 2 + 2 + 2 + 4 + ToOffsetSize(_table.IsBigBlob) + ToOffsetSize(_table.IsBigStrings) + ToOffsetSize(_table.IsBigStrings) + ToOffsetSize(_table.IsBigBlob), _table.IsBigBlob);
	...
	public sealed unsafe class FileRow : TableRow {
		...
		public uint HashValue => ReadHeapOffset(RawDataUnsafe + 4 + ToOffsetSize(_table.IsBigStrings) + ToOffsetSize(_table.IsBigBlob), _table.IsBigBlob);
		// ULONG + STRING + BLOB
	...
	public sealed unsafe class ExportedTypeRow : TableRow {
		...
		public uint TypeName => ReadHeapOffset(RawDataUnsafe + 4 + 4 + ToOffsetSize(_table.IsBigStrings), _table.IsBigStrings);
		// ULONG + ULONG + STRING

		public uint TypeNamespace => ReadHeapOffset(RawDataUnsafe + 4 + 4 + ToOffsetSize(_table.IsBigStrings) + ToOffsetSize(_table.IsBigStrings), _table.IsBigStrings);
		// ULONG + ULONG + STRING + STRING

		public uint Implementation => ReadUInt16(RawDataUnsafe + 4 + 4 + ToOffsetSize(_table.IsBigStrings) + ToOffsetSize(_table.IsBigStrings) + 2);
	...
	public sealed unsafe class ManifestResourceRow : TableRow {
		...
		public uint Name => ReadHeapOffset(RawDataUnsafe + 4 + 4 + ToOffsetSize(_table.IsBigStrings), _table.IsBigStrings);
		// ULONG + ULONG + STRING

		public uint Implementation => ReadUInt16(RawDataUnsafe + 4 + 4 + ToOffsetSize(_table.IsBigStrings) + 2);
	...
	public sealed unsafe class GenericParamRow : TableRow {
		...
		public uint Name => ReadHeapOffset(RawDataUnsafe + 2 + 2 + 2 + ToOffsetSize(_table.IsBigStrings), _table.IsBigStrings);
